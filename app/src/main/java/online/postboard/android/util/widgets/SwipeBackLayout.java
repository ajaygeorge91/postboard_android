    ...
    private void findScrollView(ViewGroup viewGroup) {
        ...
        if (viewGroup.getChildCount() > 0) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (child instanceof AbsListView || child instanceof ScrollView || child instanceof RecyclerView || child instanceof ViewPager || child instanceof WebView) {
                    scrollChild = child;
                    return;
                }
            }
    ...
    private class ViewDragHelperCallBack extends ViewDragHelper.Callback {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if (enableFlingBack && backBySpeed(xvel, yvel)) {
                isBack = (!canChildScrollUp() || !canChildScrollDown());
