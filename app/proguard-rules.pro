...
# Keep fields of models so Gson can find their names
-keepclassmembers class online.postboard.android.data.model.** {
   <fields>;
}
...
-keepclassmembers class online.postboard.android.data.remote.PbService$** {
    <fields>;
}
...
# https://stackoverflow.com/questions/17753988/android-proguard-didnt-compile-with-joda-time-jar-file/17756875#17756875
